  ...
  build =
    ...
    stdenv.mkDerivation rec {
      ...
      src = fetchFromGitHub {
        ...
        rev = "v${version}";
        sha256 = "sha256-ThdtiDFstvWbz5VML+jPwFl/kfN3gcniY9TtbcGzW28=";
      };
      ...
      patches = [
        (fetchpatch {
          url = "https://patch-diff.githubusercontent.com/raw/digitalocean/prometheus-client-c/pull/79.patch";
          sha256 = "sha256-TG2yLmAwC7MGeU3jb3Xn5szxtEtoWlunc/1CKNy2Isg=";
        })
      ];
